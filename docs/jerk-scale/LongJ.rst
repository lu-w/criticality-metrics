...
The usage of LongJ and LatJ varies, e.g. LongJ can be utilized in the design of an ACC [ISO15622]_ function, whereas LatJ is used for functions dealing with steering maneuvers, e.g. an LKAS [ISO11270]_. 
